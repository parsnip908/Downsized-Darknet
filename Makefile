...
OBJ=image_opencv.o http_stream.o gemm.o utils.o dark_cuda.o convolutional_layer.o list.o image.o activations.o im2col.o col2im.o blas.o maxpool_layer.o data.o matrix.o network.o parser.o option_list.o darknet.o captcha.o route_layer.o writing.o box.o nightmare.o dice.o detector.o layer.o compare.o classifier.o swag.o rnn.o rnn_vid.o demo.o tag.o cifar.o go.o batchnorm_layer.o art.o super.o voxel.o tree.o yolo_layer.o upsample_layer.o
ifeq ($(GPU), 1)
LDFLAGS+= -lstdc++
