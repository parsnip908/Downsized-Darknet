...
OBJ=image_opencv.o http_stream.o gemm.o utils.o convolutional_layer.o list.o image.o activations.o im2col.o col2im.o blas.o \
	maxpool_layer.o data.o network.o parser.o option_list.o darknet.o route_layer.o box.o detector.o layer.o batchnorm_layer.o \
	yolo_layer.o upsample_layer.o fixed.o
ifeq ($(GPU), 1)
LDFLAGS+= -lstdc++
OBJ+=convolutional_kernels.o activation_kernels.o im2col_kernels.o col2im_kernels.o blas_kernels.o crop_layer_kernels.o \
	dropout_layer_kernels.o maxpool_layer_kernels.o network_kernels.o avgpool_layer_kernels.o
endif
