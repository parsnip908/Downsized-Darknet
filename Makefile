...
OBJ=image_opencv.o http_stream.o gemm.o utils.o dark_cuda.o convolutional_layer.o list.o image.o activations.o im2col.o col2im.o blas.o maxpool_layer.o data.o matrix.o network.o parser.o option_list.o darknet.o route_layer.o box.o detector.o layer.o batchnorm_layer.o yolo_layer.o upsample_layer.o
ifeq ($(GPU), 1)
LDFLAGS+= -lstdc++
